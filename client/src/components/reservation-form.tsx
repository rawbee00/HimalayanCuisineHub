...
const reservationSchema = z.object({
  ...
  guests: z.number().min(1).max(20, 'Maximum 20 guests per reservation'),
...
export function ReservationForm({ onSuccess }: { onSuccess?: () => void }) {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent>
        <form id="reservation-form" className="reservation-form space-y-6" onSubmit={handleSubmit(onSubmit)}>
